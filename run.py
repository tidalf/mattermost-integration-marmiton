...
#        sys.exit()
    ...
    port = os.environ.get('MATTERMOST_MARMITON_PORT', None) or os.environ.get('PORT', 6000)
    host = os.environ.get('MATTERMOST_MARMITON_HOST', None) or os.environ.get('HOST', '127.0.0.1')
